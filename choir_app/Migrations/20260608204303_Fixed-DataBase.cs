    ...
    public partial class FixedDataBase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Admin chór", "1", 0 },
                    { 2, true, new DateTime(2025, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Jan Kowalski", "2", 4 }
                });
