    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Voice = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChoirMembers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 0, "75b85f35-8125-45e2-b607-f102ef50cda5", "admin@choir.pl", true, true, false, null, "ADMIN@CHOIR.PL", "ADMIN@CHOIR.PL", "AQAAAAIAAYagAAAAEGfXTwIXZQH74mYzqKOqHYA/+RMONiMrmXRGn7DKmz5dbwN+mHRJUiqRxcZwKF7UoQ==", null, false, "0ae13f52-baab-41ce-a954-907a5373c72d", false, "admin@choir.pl" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 12, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Kraków", "Koncert Bożonarodzeniowy" },
                    { 2, new DateTime(2026, 12, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sala prób", "Próba generalna" }
                });
